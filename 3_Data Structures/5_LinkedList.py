...
We have created a Node class in which we have defined an __init__ function to initialize the node with the data passed as an argument and a reference with None because if we have only one node.
'''
